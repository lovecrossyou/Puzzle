...
@interface FortuneWebController()<UIWebViewDelegate>
...
@implementation FortuneWebController
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    [webView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.mas_equalTo(UIEdgeInsetsMake(0, 9, 9, 9));
    }];
...
-(void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    self.view.backgroundColor = [UIColor colorWithHexString:@"4964ef"] ;
