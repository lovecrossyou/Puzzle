...
- (void)switchToVoiceInputMode {
  ...
  [self.voiceButton setImage:[UIImage imageNamed:@"chat_btn_vioce"] forState:UIControlStateNormal];
  [self.voiceButton setImage:[UIImage imageNamed:@"chat_btn_vioce"] forState:UIControlStateHighlighted];
...
- (void)drawRect:(CGRect)rect {
  ...
  [self.startRecordButton setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
  [self.startRecordButton setTitleColor: [UIColor darkGrayColor] forState:UIControlStateHighlighted];
  ...
  [self.startRecordButton setBackgroundColor:HBColor(243, 243, 243)];
  self.startRecordButton.layer.masksToBounds = YES ;
  self.startRecordButton.layer.cornerRadius = 4 ;
  self.startRecordButton.layer.borderColor = [UIColor lightGrayColor].CGColor;
  self.startRecordButton.layer.borderWidth = 1 ;
