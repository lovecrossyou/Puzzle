...
//  [addView setBackgroundColor:[UIColor clearColor]];
  ...
  [addView setBackgroundImage:[UIImage imageNamed:@"chat-details_btn_add-friends-"] forState:UIControlStateNormal];
  [addView setBackgroundImage:[UIImage imageNamed:@"chat-details_btn_add-friends-"] forState:UIControlStateHighlighted];
...
- (void)viewWillAppear:(BOOL)animated {
  ...
  [self.conversation.target thumbAvatarData:^(NSData *data, NSString *objectId, NSError *error) {
    if (error == nil) {
      ...
      if (data == nil) {
        [_headView setImage:[UIImage imageNamed:@"default-avatar"]];
